      ...
      >
        ...
        <ScrollView style={{ flex: 1 }}>
          ...
          <Text style={styles.text}>
            ...
            property rights related to it, still belong to Masoom Raj. Masoom
            Raj is committed to ensuring that the app is as useful and efficient
            as possible. For that reason, we reserve the right to make changes
            to the app or to charge for its services, at any time and for any
            ...
            TeleGang app stores and processes personal data that you have
            ...
            mean that the TeleGang app won’t work properly or at all. The app
            ...
            {"\n"}
            {"\n"}
            You should be aware that there are certain things that Masoom Raj
            ...
            provider, but Masoom Raj cannot take responsibility for the app not
            ...
            bill payer for using the app. Along the same lines, Masoom Raj
            ...
            out of battery and you can’t turn it on to avail the Service, Masoom
            Raj cannot accept responsibility. With respect to Masoom Raj’s
            ...
            available to you. Masoom Raj accepts no liability for any loss,
            ...
            to download the updates if you want to keep using the app. Masoom
            Raj does not promise that it will always update the app so that it
          ...
          <Text style={styles.bold}>Changes to This Terms and Conditions</Text>
          <Text style={styles.text}>
            ...
            this page. These terms and conditions are effective as of 2020-07-12
          </Text>
          <Text style={styles.bold}>Contact Us</Text>
          <Text style={styles.text}>
            If you have any questions or suggestions about my Terms and
            Conditions, do not hesitate to contact me at raj.8@iitj.ac.in. This
            Terms and Conditions page was generated by App Privacy Policy
            Generator
            {"\n"}
            {"\n"}
            {"\n"}
